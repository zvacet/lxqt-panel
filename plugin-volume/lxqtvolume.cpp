...
// This slot will be called by VolumeButton::showEvent()
void LxQtVolume::delayInit()
{
    qDebug("LxQtVolume::delayInit()");
    ...
    // handle events since we already blocked for a while
    qApp->processEvents();
    ...
    qDebug("Finish LxQtVolume::delayInit()");
}
